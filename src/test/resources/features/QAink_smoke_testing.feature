...
#    Then I check the Complex Memo will be displayed in Barebone Disclosure
  ...
  Scenario: SAP - DTWP
    ...
    And I answer "Misstatement(s) identified; however, they are clearly trivial or qualitatively insignificant." to Tailoring question "Have any misstatements been identified?" in SAP
